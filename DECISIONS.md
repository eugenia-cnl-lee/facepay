...
- **Decision:** Very high-value payments (≥ £200) require a **second, different enrolled approver's face** on top of face + PIN — a two-person rule (**dual control / maker-checker**). **Self-approval is blocked**, and only people designated as approvers can approve.
